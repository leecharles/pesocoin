...
uint256 hashGenesisBlock("0x00000c3e000632ea2662eee5b181269cba2cbed3dcf799798b558ad27fbe1d21");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // PesoCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PesoCoin Signed Message:\n";
...
{
    // PesoCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // PesoCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "peso genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xf2, 0xc3, 0xb9, 0xde }; // PesoCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PesoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PesoCoinMiner : ProcessBlock, block not accepted");
    }
